                                    ...
                                    <form action="{{ route('kategoris.update', $kategori->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                                rows="5"
                                                placeholder="Masukkan Deskripsi">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($kategori->icon)
                                                <img src="{{ asset('storage/' . $kategori->icon) }}" alt="Current Icon" style="max-width: 100px; margin-bottom: 10px;">
                                            @endif
