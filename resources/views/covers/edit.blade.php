                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm rounded">
                                <div class="card-header bg-primary text-white">
                                    <h5 class="mb-0">Form Edit Cover</h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('covers.update', $cover->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $cover->name) }}" placeholder="Masukkan Nama Cover">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($cover->image)
                                                <img src="{{ asset('storage/' . $cover->image) }}" alt="Current Cover" class="img-preview">
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($cover->logo)
                                                <img src="{{ asset('storage/' . $cover->logo) }}" alt="Current Logo" class="img-preview">
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kategori_id" class="form-control" required>
                                                @foreach ($kategoris as $kategori)
                                                    <option value="{{ $kategori->id }}" {{ $kategori->id == $cover->kategori_id ? 'selected' : '' }}>
                                                        {{ $kategori->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Konten">{{ old('content', $cover->content) }}</textarea>
                                            @error('content')
                                                <div class="alert alert-danger mt-2">
                                                    {{ $message }}
                                                </div>
...
<!-- Edited By Input -->
<div class="form-group">
    <label class="font-weight-bold">Edited By</label>
    <input type="text" class="form-control" name="edited" value="{{ old('edited', $cover->edited) }}" placeholder="Masukkan nama editor">
</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                ...
                                                <option value="draft" {{ $cover->status == 'draft' ? 'selected' : '' }}>Draft</option>
                                                <option value="publish" {{ $cover->status == 'publish' ? 'selected' : '' }}>Publish</option>
                                            </select>
                                        </div>
