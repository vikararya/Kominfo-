...
Route::middleware(['auth', \App\Http\Middleware\RoleMiddleware::class . ':super-admin'])->group(function () {
    ...
    Route::get('/api/get-versi/{coverId}', [VersiController::class, 'getVersi']);
...
// Middleware khusus untuk Administrator
Route::middleware(['auth', \App\Http\Middleware\RoleMiddleware::class . ':administrator'])->group(function () {
    // Administrator hanya dapat mengedit profil mereka sendiri
