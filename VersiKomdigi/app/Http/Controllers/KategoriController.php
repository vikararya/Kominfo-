...
class KategoriController extends Controller
{
    ...
    //     $kategoris = Kategori::create(array_merge($validated, [
    //         'name' => $request->name,
    ...
    //     return redirect()->route('kategoris.index')->with('success', 'Dokumentasi created successfully.');
    // }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'deskripsi' => 'required|string',
            'icon' => 'required|image|mimes:png|max:2048', // Hanya menerima PNG dengan maksimal 2MB
        ], [
    ...
    //     $kategori->update(array_merge($validated, [
    //         'name' => $validated['name'],
    //         'deskripsi' => $validated['deskripsi'],
    //         'icon' => $kategori->icon,
    //     ]));
