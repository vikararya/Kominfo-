...
<head>
    ...
    .file-input-label img {
        border: 2px dashed #ccc; /* Border untuk gambar placeholder */
        padding: 10px;
        border-radius: 5px;
    }
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">Web Dokumentasi</div>
            </a>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $admin->email) }}" placeholder="Masukkan Email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">Password lama tidak bisa diubah, hanya bisa diganti.</small>
                                        </div>

                                        <div class="form-group">
                                            <label class="font-weight-bold">Password</label>
                                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password', $admin->passwordl) }}" placeholder="Masukkan Password">
