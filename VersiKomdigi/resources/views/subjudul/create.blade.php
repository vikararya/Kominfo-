        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <h4 class="mb-4 text-center">Tambah Data Dokumentasi</h4>
                        <form action="{{ route('subjudul.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="dokumentasi_id" id="dokumentasi_id" class="form-control select2" required>
                                    <option value="" disabled selected>Pilih Judul Dokumentasi</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('subjudul') is-invalid @enderror"
                                    name="subjudul" value="{{ old('subjudul') }}" placeholder="Masukkan Subjudul">
                                @error('subjudul')
